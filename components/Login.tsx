...
const Login = () => {
  ...
  return (
    <form className="relative flex flex-col w-full items-center justify-center bg-[url('/login-bg-img.jpg')] bg-cover bg-center bg-no-repeat rounded-xl">
      <div className="flex flex-col w-full h-full max-w-[80%] max-h-[90%] my-10 bg-primary/50 rounded-2xl px-15 pt-2">
        ...
        />
        <label className="text-xl text-white font-light mt-5">
          Enter password
        </label>
        <input
          id="password"
          ...
          className="bg-white rounded-md h-12 px-5 py-2 mt-3 placeholder:text-xl text-3xl font-light tracking-widest"
        />
        <button
          type="button"
